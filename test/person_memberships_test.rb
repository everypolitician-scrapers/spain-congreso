...
describe PersonMemberships do
  ...
  let(:profile_url) do
    'http://www.congreso.es/portal/page/portal/Congreso/Congreso/Diputados/BusqForm?next_page=/wc/fichaDiputado?idDiputado=338&idLegislatura=12'
  end

  let(:list_url) do
    'http://www.congreso.es/portal/page/portal/Congreso/Congreso/Diputados/BusqForm?next_page=/wc/listadoFichas?idDiputado=338&idLegislatura=12'
  end
  ...
  describe 'membership row' do
    it 'should contain the expecte data' do
      list_page_response.memberships
                        .first
                        .to_h
                        .must_equal(url:         'http://www.congreso.es/portal/page/portal/Congreso/Congreso/Diputados/BusqForm?next_page=/wc/fichaDiputado&idLegislatura=12&idDiputado=338',
                                    legislatura: 12,
